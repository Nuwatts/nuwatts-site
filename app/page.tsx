      ...
      <main id="top" className="flex-1">
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <VisualCard
              src="/visuals/hidden-cost-slide.png"
              alt="Hidden cost visual comparing conventional thermal overhead to Nuwatts"
            />
          </div>
        </Section>
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <Panel>
              <div className="mb-5 text-sm uppercase tracking-[0.2em] text-white/50">Thermal-management overhead model</div>
